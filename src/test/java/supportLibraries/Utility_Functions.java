...
public class Utility_Functions extends ReusableLib {
    ...
    /*
     * ******************************************************************* Function
     * Name: Random String Function Author : GSInfo Team Purpose :
     * ******************************************************************
     */
    private static final String ALPHA_NUMERIC_STRING = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
    static Properties properties = Settings.getInstance();

    public static String jsonFile = "src/test/resources/MiddleLayerDataFiles/" + properties.getProperty("ENV") + "_" + properties.getProperty("RunTimeDataFile") + ".json";
    public static String jsonMasterFile = "src/test/resources/MiddleLayerDataFiles/" + properties.getProperty("ENV") + "_" + properties.getProperty("MasterDataFile") + ".json";
    public static String middleLay = "src/test/resources/MiddleLayerDataFiles/";
//"src/test/resources/Datatables/RunTimeData.json";
    /*
     * ******************************************************************* Function
     * Name: xHighlight Author : GSInfo Team Highlight the element Parameters:
...
//			newDate = sdf.format(dtDob);
    ...
    public static WebElement findElementByXpath(FrameworkDriver driver, By element_xpath) {
        try {
            return driver.findElement((element_xpath));
        } catch (NoSuchElementException e) {
            return null;
        } catch (Exception e) {
            return null;
    ...
    public static WebElement findElementByXpath(FrameworkDriver driver, String webElenmentString, String toBeReplced,
        ...
        try {
            ...
            xWaitForElementPresent(driver, el, 4);
    ...
    /*
     * ******************************************************************* Function
     * Name: inputData Author : GSInfo Team Inputs the data: tagID, value
     * ******************************************************************
     */
    ...
    // ******************************************************************
    /*
     * Function Name: findWebElementById Author : GSInfo Team Element finder by
     * ID ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xSelectRadio Author : GSInfo Team Selects the radio button : driver,
     * webelement ******************************************************************
     */
     ...
     * xWaitForElementClickable, xWaitForElementAttribute Author : Team GSInfo :
    ...
    // Static wait for specified time
    public static void timeWaitMiliSeconds(int time) {
        try {
    ...
    /*
     * ******************************************************************* Function
     * Name: validateFieldMatch Author : GSInfo Team Validates field match:
    ...
    /*
     * ******************************************************************* Function
     * Name: xClickButton Author : GSInfo Team Added to click on Button items of
    ...
    /*
     * ******************************************************************* Function
     * Name: xClick Author : GSInfo Team Click on element with or without
    ...
    /*
     * ******************************************************************* Function
     * Name: findWebElementBylinkText Author : GSInfo Team Purpose : Element
     * finder by linkText
     * ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: findWebElementByXpath Author : GSInfo Team : Element finder by xpath
     * ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xClickVisibleListElement Author : GSInfo Team Purpose : Click the
    ...
    public static String getDBUrl(String dbname) {
        ...
        switch (dbname) {
            ...
            case "STGXStore":
                url = properties.getProperty("STGXStore");
                break;
            case "RMSStg":
            case "ReSaStg":
                // url = "jdbc:oracle:thin:@scan-stg01-exacs.opc.lllint.com:1521/stgmom01.us2.oraclecloud.com";
                //  url = "jdbc:oracle:thin:@cfclscan-c8r1503.us2.oraclecloud.com:1521/stgmom01.us2.oraclecloud.com";
                switch (dbEnv) {
                    case "STG":
                        url = "";
                        break;
    ...
    /*
     * ******************************************************************* Function
     * Name: inputValueWithReport Author : GSInfo Team : Inputs the value with in
    ...
    /*
     * ******************************************************************* Function
     * Name: xSelectDropdown,xSelectDropdownByName Author : GSInfo Team
    ...
    /**
     * Method to Connect with Master JSON file and return Value for specific Key
     *
     * @param Key Name of Key
     * @return Object
     */
    public static String xGetMasterJsonData(String Key) {
        try {

            Object obj = new JSONParser().parse(new FileReader(jsonMasterFile));
    ...
    public static boolean xActionClick(By by, FrameworkDriver driver) {
    ...
    public static void xMouseClick(FrameworkDriver driver, By by) {
    ...
    /*
     * ******************************************************************* Function
     * Name: xmouseOver Author : GSInfo Team
    ...
    /*
     * ******************************************************************* Function
     * Name: xMouseHoverOnElment Author : GSInfo Team
     * Mouse Hover over element
     * Parameters: webelement, driver
     * ******************************************************************
     */
    
    public static void xMouseHoverOnElment(By el, FrameworkDriver driver) {
    ...
    public static void xMouseHoverOnElment(WebElement el, FrameworkDriver driver) {
    	Actions builder = new Actions(driver.getWebDriver());
        builder.moveToElement(el).perform();
    ...
    /*
     * ******************************************************************* Function
     * Name: xgetRandomNumber Author : GSInfo Team
     * method to get range bound random number
     * Parameters: int min, int max
     * ******************************************************************
     */

    public static int xgetRandomNumber(int min, int max) {
    	int value=0;
    	try {
    		Random random = new Random();
    		value = (int) (random.nextInt(max - min) + min);
    	}catch (Exception e) {
    ...
    /*
     * Function to update data to MasterData sheet
     * @author : Rudra
     */
    @SuppressWarnings("unchecked")
    public static void xUpdateMasterJson(String Key, String value) {
        try {
            createJsonFile(jsonMasterFile);
            Object obj = new JSONParser().parse(new FileReader(jsonMasterFile));
            ...
            PrintWriter pw = new PrintWriter(jsonMasterFile);
    ...
    /*
     * Function to get data from MasterData sheet
     * @author : Rudra
     */
    public static String xGetMasterJsonAsString(String path) {
        File f = new File(jsonMasterFile);
        String obj = null;
        ReadContext wctx;
        try {
            wctx = JsonPath.parse(f);
...
//		};
    ...
    /*
     * ******************************************************************* Function
     * Name: xScrollWindow Author : GSInfo Team Hover and action Parameters:
     * driver ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xHighlight Author : GSInfo Team Purpose : Highlight the element
    ...
    /*
     * ******************************************************************* Function
     * Name: xSwitc Author : GSInfo Team Purpose : Highlight the element
     * Parameters: driver, webelement, color = e.g yellow, green etc
     * ******************************************************************
     */
    ...
    /*
     * ******************************************************************* Function
     * Name: xContainsvalue Author : GSInfo Team Takes a given driver and window
     ...
     * @param count How many times it need to be pressed
     */
    public static void xSendKeyBoardkeys(int key, int count) {
        try {
            Robot rb = new Robot();
            for (int i = 0; i < count; i++) {
                rb.keyPress(key);
     ...
     * @param key Pass Keyboad Key
     */
    public static void xSendCtrlPlusKey(int key) {
        try {
            Robot rb = new Robot();
     ...
     * Method to Send Keyboard keys in Loop
     *
     * @param key Pass multiple  Keyboad Key
     */
    public static void xSendmultipleKeyBoardkeys(int... key) {
        try {
            Robot rb = new Robot();
    ...
    /*
     * ******************************************************************* Function
     * Name: xSendKeys Author : GSInfo Team Send keys to the input field: driver,
    ...
    /*
     * ******************************************************************* Function
     * Name: xSendKeysVisibleListElement Author : GSInfo Team Purpose : SendKeys
    ...
    /*
     * ******************************************************************* Function
     * Name: Miscellaneous functions Author : GSInfo Team Purpose : Hover and
     ...
     * ******************************************************************
     */
    public static boolean xswitchedToFrame(FrameworkDriver driver, By webElement) {
        driver.switchTo().defaultContent();
        List<WebElement> iframeList = driver.findElements(By.tagName("iframe"));
        timeWait(2);
    ...
    /*
     * ******************************************************************* Function
     * Name: xSwitc Author : GSInfo Team Purpose : Switch to Parent Window
    ...
    /*
     * ******************************************************************* Function
     * Name: xWaitForElementPresentInPage Author : GSInfo Team
     * Purpose : Wait for element to be visible height & width > 0
     * ******************************************************************
     */
    
    public static boolean xWaitForElementPresentInPage(FrameworkDriver driver, By el, int timeWait) {
    	boolean result = false;
        try {
            WebDriverWait wait = new WebDriverWait(driver.getWebDriver(), timeWait);
    ...
    public static boolean xWaitForElementPresentInPage(FrameworkDriver driver, WebElement el, int timeWait) {
    	boolean result = false;
        try {
            WebDriverWait wait = new WebDriverWait(driver.getWebDriver(), timeWait);
    ...
    public static boolean waitForElementVisible(FrameworkDriver driver, WebElement el, int timeWait) {
        try {
